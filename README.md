...
Althrough every members of the team contributed to each part of the project, everyone created React components, styled the frontend pages, created Lambda functions and participated in testing, 
my biggest contribution was the serverless backend on AWS.    
I have created the DynamoDB table, the first iteration of Lambda functions and the API gateway. 
